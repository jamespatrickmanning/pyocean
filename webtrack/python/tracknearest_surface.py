...
@author: Y Wang and J Manning

Routine to crudely track a particle at constant depth through FVCOM fields.
This does NOT use Runge Kutta

See control file called "ctrl_trackzoomin.csv" to input thing like:
time to start, depth, #days but enter drop location in hardcode below.    

This version selects either the "massbay" or "30yr" models.
Others could be added.

This version plots model nodes but no coastline of bathy.
"""
...
print "Output filename called "+urlname+"_drifttrack.png by default"
...
plt.show()
plt.title(urlname+' modelled track at '+str(depth)+' meters starting:'+str(TIME)) 
plt.savefig(urlname+'_driftrack.png')
