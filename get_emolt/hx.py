...
def plot_getsst(ask_input,utc,gbox):
  ...
  CS = plt.contourf(X,Y,sst_part[0],numpy.arange(min(sst_part[0]),max(sst_part[0]),(max(sst_part[0])-min(sst_part[0]))/14.0))
  #CS = plt.contourf(X,Y,sst_part[0],numpy.arange(0,30,2))
